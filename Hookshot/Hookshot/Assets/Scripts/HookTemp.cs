...
public class HookTemp : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (!fired && Input.GetButtonDown("Fire2"))
        {
            ...
            direction = mousePOS - parent.transform.position;
            direction.Normalize();
        ...
        if (fired)
        {
            ...
            Vector3 HookToPlayer = transform.position - parent.transform.position;
    ...
    private void Retract()
    {
        ...
        {
            handOffDirection = transform.position - parent.transform.position;
